 ...
 * @author TheCelavi
 */
class dmFacebookSocialPluginsRecommendationsForm extends dmWidgetPluginForm {
    ...
    public function configure() {
        ...
        // Border color
        $this->widgetSchema['borderColor'] = new sfWidgetFormInputText();
        $this->validatorSchema['borderColor'] = new sfValidatorString(
                array(
                    'required'=> false                    
                )
        );
